...
const Map = () => {
    ...
    const handleMarkerSellectedPositon = (id) => {
        navigate(`${id}/1`)
    }
    const [selectedPosition, setSelectedPosition] = useState(null);
    const buildingId = selectedPosition?.id;
    ...
    return (
        <div style={{ width: "100%", height: "900px" }}>
            ...
            >
                ...
                {selectedPosition && (
                    <Marker position={location} icon={placeHolder}
                        eventHandlers={{

                            click: (e) => {
                               
                                handleMarkerSellectedPositon(buildingId)
                            },
                        }}
